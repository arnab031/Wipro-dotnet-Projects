...
namespace AzureMvc01.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DName,IsActive")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DName,IsActive")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
